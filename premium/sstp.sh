...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/check-sstp https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/check-sstp.sh && chmod +x /usr/bin/check-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
