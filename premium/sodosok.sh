...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/del-ss.sh"
wget -O check-ss "https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/check-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/dsantos3526/SERVER/main/premium/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x check-ss
chmod +x renew-ss
